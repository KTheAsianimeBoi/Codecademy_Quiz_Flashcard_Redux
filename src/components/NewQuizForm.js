...
import { topicsSelect } from "../features/topics/topicsSlice"
import { createQuizAndAssociate } from "../features/quizzes/quizzesSlice"
...
export default function NewQuizForm() {
	...
	const topics = useSelector(topicsSelect)
	...
	const handleSubmit = (e) => {
		...
		dispatch(createQuizAndAssociate({ id: uuidv4(), name: name, topicId: topicId, cardIds: cardIds }))
